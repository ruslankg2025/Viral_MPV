...
from covers.router import router as covers_router
...
# ---------------------------------------------------------------- #
# Covers (обложки рилсов — вкладка «Обложки»; фото-библиотека + сохранённые
# обложки; рендер на клиенте, сервер только хранит/отдаёт ассеты)
# ---------------------------------------------------------------- #
