...
_REFINE_INSTRUCTIONS: dict[str, str] = {
    ...
    "expand":
        "Увеличь объём сценария примерно в полтора-два раза: добавь 2–3 новые сцены, "
        "разверни существующие — конкретика, примеры, детали, аргументы, эмоция. "
        "НЕ повторяй уже сказанное и не лей воду: каждая новая сцена несёт новую мысль. "
        "Сохрани стиль, hook и CTA. Итоговая длительность заметно больше исходной.",
}
